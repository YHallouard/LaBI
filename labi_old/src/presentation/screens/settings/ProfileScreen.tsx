...
export const ProfileScreen: React.FC = () => {
  ...
  const [saveUserProfileUseCase, setSaveUserProfileUseCase] =
    useState<SaveUserProfileUseCase | null>(null);
  const [editUserProfileUseCase, setEditUserProfileUseCase] =
    useState<EditUserProfileUseCase | null>(null);
  const [retrieveUserProfileUseCase, setRetrieveUserProfileUseCase] =
    useState<RetrieveUserProfileUseCase | null>(null);
  ...
  const loadProfile = async (
    retrieveUseCase?: RetrieveUserProfileUseCase | null
  ) => {
