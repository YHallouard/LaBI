...
export const LAB_VALUE_DEFAULT_RANGES = {
  ...
  "Protéine C Reactive": { min: 0.0, max: 5.0 },
  ...
  "Cholestérol HDL": { min: 0.4, max: 10 },
  "Cholestérol LDL": { min: 0.0, max: 1.6 },
...
export const LAB_VALUE_EXPLANATIONS: Record<string, string> = {
  ...
  "Cholestérol HDL": "Le cholestérol HDL (lipoprotéines de haute densité) est souvent appelé \"bon cholestérol\" car il participe au transport inverse du cholestérol, des tissus périphériques vers le foie où il est éliminé. Il possède des propriétés anti-inflammatoires, antioxydantes et contribue à la protection cardiovasculaire. Un taux bas de HDL (<0,4 g/L) est un facteur de risque cardiovasculaire indépendant et peut être associé à l'obésité, la sédentarité, le tabagisme ou des facteurs génétiques. Un taux élevé est généralement bénéfique, bien que certaines élévations pathologiques existent.",
  
  "Cholestérol LDL": "Le cholestérol LDL (lipoprotéines de basse densité), souvent appelé \"mauvais cholestérol\", transporte le cholestérol du foie vers les tissus périphériques. En excès, il s'accumule dans les parois artérielles, formant des plaques d'athérome qui peuvent obstruer les vaisseaux et causer des maladies cardiovasculaires. Un taux élevé est influencé par des facteurs génétiques, l'alimentation, la sédentarité ou certaines pathologies. L'objectif thérapeutique varie selon le niveau de risque cardiovasculaire global du patient, avec des cibles plus basses pour les personnes à haut risque ou en prévention secondaire.",
